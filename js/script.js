...
well enough to fit the criteria but it is definitely something that I feel is very basic and there is still so much left for me to learn when it comes to webdev stuff. I also need to further my skills with
all the different types of code and documents for a single website so that things work well together and also follow an easy to understand hierarchy 
